...
/// دايلوج انقطاع الإنترنت أو تعذّر الوصول للسيرفر
class ConnectivityErrorDialog extends StatelessWidget {
  ...
  /// يعرض الدايلوج ويعيد `true` عند الضغط على «إعادة المحاولة»
  static Future<bool> show(
    ...
    return showDialog<bool>(
      ...
      builder: (_) => ConnectivityErrorDialog(
        barrierDismissible: barrierDismissible,
      ),
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Text(
                          ConnectivityService.connectionMessage,
